...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { avatar: @producto.avatar, caracteristicas: @producto.caracteristicas, descripcion: @producto.descripcion, es_propio: @producto.es_propio, es_servicio: @producto.es_servicio, especificaciones: @producto.especificaciones, nombre: @producto.nombre, nombre_empresa: @producto.nombre_empresa, sitio_empresa: @producto.sitio_empresa, url_prod_empresa: @producto.url_prod_empresa } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { avatar: @producto.avatar, caracteristicas: @producto.caracteristicas, descripcion: @producto.descripcion, es_propio: @producto.es_propio, es_servicio: @producto.es_servicio, especificaciones: @producto.especificaciones, nombre: @producto.nombre, nombre_empresa: @producto.nombre_empresa, sitio_empresa: @producto.sitio_empresa, url_prod_empresa: @producto.url_prod_empresa } }
